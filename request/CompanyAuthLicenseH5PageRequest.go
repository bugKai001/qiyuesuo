...
func (obj CompanyAuthLicenseH5PageRequest) GetUrl() string {
	return "/companyauth/h5pagewithlicense"
}

func (obj CompanyAuthLicenseH5PageRequest) GetHttpParameter() *http.HttpParameter {
