...
type Contract struct {
	...
	InvalidExpireTime string `json:"invalidExpireTime,omitempty"`
	InvalidFailType   string `json:"invalidFailType,omitempty"`
	NotifySponsor     *bool  `json:"notifySponsor,omitempty"`
}
